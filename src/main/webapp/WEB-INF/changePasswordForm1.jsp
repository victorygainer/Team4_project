...
<script type="text/javascript">
	function passwordCheckFunction() {
		...
		if (userPassword1 == userPassword2) {
			...
			$('#passwordCheckMessage2').html('비밀번호가 일치하지 않습니다.')
		}
	}
	...
	<div class="row content">
		<div class="col-sm-3 sidenav">
				<ul class="nav-left">
					...
					<li><a href="logout.nhn">로그아웃</a></li>
					<h5>My Account</h5>
					<li><a href="mypageView.nhn">회원정보수정</a></li>
					<li><a href="myContentView.nhn">여행지 수정(update required)</a></li>
					<br />
					<li>
					...
					<li><a href="#">상품 리뷰(update required)</a></li>
					<br />
					<h5>Customer Service</h5>
					<li><a href="#">상품 문의(update required)</a></li>
				</ul>
			</div>
