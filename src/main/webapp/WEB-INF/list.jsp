			...
			<table class="table table-striped"
				...
				<thead>
					...
					Travel List <br/>
						...
						<h3 style ="color: white; text-align: right;"> ${contentList.totalCount} (${contentList.currentPage} / ${contentList.totalPage}) &nbsp; &nbsp;</h3>
					</h3>
					</div>
					<tr>
					...
					<tbody>
						...
						<tr>
							...
							<td align="center">
								...
								<c:set var="subject" value="${fn:replace(vo.subject, '>', '&gt;')}"></c:set>
								<a href="increment.nhn?idx=${vo.idx}&currentPage=${contentList.currentPage}">${subject}</a>
							</td>
							<td align="center">
